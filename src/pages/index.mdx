...
该插件是基于 [obsidian-plugin-proxy](https://github.com/binyu1231/obsidian-plugin-proxy) 修改而来，感谢原作者。在原来的基础上新增了下面的功能：
...
效果如图所示：
  ...
  <img src="/images/feature.png" width="80%" style={{margin: '15px 0'}} />
...
打开Obsidian设置 - Plugin Proxy - 粘贴下面代码添加到配置中
  ...
  <img src="/images/obsidian_proxy.jpg" width="80%" style={{margin: '15px 0'}} />
